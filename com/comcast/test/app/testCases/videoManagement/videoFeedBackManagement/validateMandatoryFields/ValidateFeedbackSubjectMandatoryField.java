...
/**
 * Class Name: ValidateFeedbackSubjectMandatoryField 
 * Description: This test case validates the subject mandatory fields of give feedback to the publisher
 * feature for the selected video by logging registered user into Comcast
 * application.
 * **/

public class ValidateFeedbackSubjectMandatoryField extends BaseTest 
{
	UserLoginFunctions userLogin = new UserLoginFunctions();
	UserRegistrationUsingComcast userReg = new UserRegistrationUsingComcast();

	@Test
	public void testValidateFeedbackSubjectMandatoryField() throws Exception 
	{
